    ...
    <SectionWrapper id="projects" className="bg-background dark:bg-black">
      ...
      <div className="mx-auto flex flex-wrap justify-center gap-8 py-12">
        {PROJECTS.map((project) => {
          ...
          return (
            <Card key={project.id} className="group overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-primary/20 bg-white dark:bg-neutral-950 border-0 max-w-sm">
